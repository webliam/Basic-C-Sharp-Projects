...
namespace Package_Express_Shipping
{
    class Program
    {
        static void Main()
        {
            ...
            if (pkgWeight <= 50)
            {
                ...
                {
                    Console.WriteLine("Unfortunity, Package too big to be shipped via Package Express. For more information connect us.Have a nice day.");
                }
            }
            else
            {
